    ...
    <div>
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav">
          ...
          <li class="active"><a href="paper-submission-icci2019.php">PAPER SUBMISSION</a></li>
...
<img src="img/ieee-logo.jpg" alt="ieee-logo" class="img-responsive">
    ...
    <h3><span>Paper Submission</span></h3><hr class="style-two">
    </div>
    <div class="about-style paper__sub--con">
    <h3><a href="https://easychair.org/conferences/?conf=icci2019" target="_blank">Click here (ICCI-2019)</a> to submit your Manuscripts/Papers.<br>
Thanks for choosing our conference for your valuable research work. The paper submission must be with <b>Easy Chair</b> with proper paper format.</h3>
<h3><a href="https://easychair.org/conferences/?conf=icci2019" target="_blank" class="btn btn-primary btn-lg">Submit your paper</a></h3>
</div>
<div class="about-style paper__sub--con">
       <h4>Guidelines</h4><hr class="style-seven">
       <ol>
         <li>Authors must submit the papers in IEEE format.</li>
          <li>At least one unique author for each accepted paper is required to register by 02.03.2019 in order for the paper to be included in the proceedings.</li>
           <li>Student registrations are acceptable only if the first author of the paper is a full time student at any institution. Student must send an official proof of full-time student status to icci2k19@gmail.com for the registration process to be completed.</li>
            <li>Please note that, according to the recently adopted IEEE conferences No Show Policy, we notify you that "IEEE reserves the right to exclude a paper from distribution after the conference(e.g. removal from IEEE Xplore) if the paper is not presented at the conference".</li>
             <li>Authors are requested to submit the papers through Easychair.</li>
