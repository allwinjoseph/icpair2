    ...
    <div>
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav">
          ...
          <li  class="active"><a href="registration-icci2019.php">REGISTRATION</a></li>
...
<div class="table-responsive">
  <table class="table table-bordered table__reg">
    ...
    <tbody>
      <tr class="success">
        <td align="center"  class="table__reg--h1">Member Type</td>
        <td align="center"  class="table__reg--h1">Amount</td>
        <td align="center"  class="table__reg--h1">Amount</td>
