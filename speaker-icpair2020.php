...
<!--header ends-->
 ...
 <div class="head-style">
    <h3><span>Speakers</span></h3><hr class="style-two">
    </div>
<div class="flex-container speaker" style="padding-top:20px; padding-bottom:20px;">
<div class="f5">
   <h2>Dr. Irene Maxine Pepperberg</h2>
  <h3>President<br>The Alex Foundation. <br> Research Associate & Lecturer<br> Harvard Uinversity<br>Cambridege, MA, USA.</h3>
